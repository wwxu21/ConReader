...
if __name__ == "__main__":
    test_json_path = "./Data/3full/test.json"
    model_path = "./saved_models/roberta-cs-5e-5-CE/nbest_predictions_-20.json"
    save_dir = "./results"
    cached_features_file ="./Data/3full/cached_dev_roberta_512-30-CD"
    ...
    torch.save({"examples": examples}, "./Data/3full/cached_dev_roberta_512-30-CD-examples")
